<thead class="table table-bordered">
    <tr>
        ...
        <th scope="col" class="{{ setActivo('proyectos') }}"><a href="proyectos">Proyectos</a>
        </th>
        <th scope="col" class="{{ setActivo('clientes') }}"><a href="clientes">Clientes</a>
        </th>
        <th scope="col" class="{{ setActivo('blog') }}"><a href="blog">Blog</a>
        </th>
